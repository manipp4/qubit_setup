...
def multiGaussianClusters(distribution,n_components=2,returnGMM=False):
...
##
#[sepPoint,beta,array([w1,w2]),array([c1,c2]),array([s1,s2])]
s=0.2
xOffset,yOffset=0,0
separatrix1=[array([0+xOffset,0+yOffset]),45,array([0.1,0.9]),array([array([-1,0]),array([1,0])]),array([s,s])]
separatrix2=[array([1+xOffset,1+yOffset]),45,array([0.5,0.5]),array([array([0,1]),array([2,1])]),array([s,s])]
separatrix3=[array([2+xOffset,2+yOffset]),45,array([0.9,0.1]),array([array([1,2]),array([3,2])]),array([s,s])]
print separatrixMulti([separatrix1,separatrix2,separatrix3], wMax=0.6)
##
