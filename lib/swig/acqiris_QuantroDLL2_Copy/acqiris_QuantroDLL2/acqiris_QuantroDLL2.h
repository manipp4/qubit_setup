...
//	6 corrections coefficients (offsets, gains, and rotation angles for two channels in quadratures) for a set of discrete frequencies, are stored in 7 tables that are properties of the class
	...
	void demodulate1ChAPhi(double *ChA,double *horPos, int nbrSegments, int nbrSamplesPerSegment,int startInSegment,int stopInSegment, double samplingTime, double frequency, double phase,int intervalMode,bool tryCorrec,bool averageOnly,int *nbrIntervalsPerSegment,double *arrayA,double *arrayPhi,double *arrayMeanA,double *arrayMeanPhi,double* P_Time_us);
	void demodulate2ChAPhi(double *ChA,double *ChB,double *horPos,int nbrSegments,int nbrSamplesPerSegment,int startInSegment,int stopInSegment,double samplingTime,double frequency,double phase,int intervalMode,bool tryCorrec,bool averageOnly,int *nbrIntervalsPerSegment,double *arrayA, double *arrayPhi,double *arrayMeanA, double *arrayMeanPhi,double* P_Time_us);
	void demodulate1ChIQ(double *ChA, double *horPos,int nbrSegments, int nbrSamplesPerSegment,int startInSegment,int stopInSegment, double samplingTime, double frequency, double phase,int intervalMode,bool tryCorrec,bool averageOnly,int *nbrIntervalsPerSegment,double *arrayI,double *arrayQ,double *arrayMeanI,double *arrayMeanQ,double* P_Time_us);
	void demodulate2ChIQ(double *ChA,double *ChB,double *horPos,int nbrSegments,int nbrSamplesPerSegment,int startInSegment,int stopInSegment,double samplingTime,double frequency,double phase,int intervalMode,bool tryCorrec,bool averageOnly,int *nbrIntervalsPerSegment,double *arrayI, double *arrayQ,double *arrayMeanI, double *arrayMeanQ,double* P_Time_us);
