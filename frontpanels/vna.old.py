...
class Panel(FrontPanel):
    ...
    def plotTraces(self):
      ...
      if len(plots) == 0:
        ...
        if self.showLegend.isChecked(): self.sc.axes.legend(legends,'lower left')
    ...
    def __init__(self,instrument,parent=None):
        ...
        self.traces.setColumnWidth(1,240)
        ...
        subGrid.addWidget(updateButtonM,0,2)
        subGrid.addWidget(self.showLegend,0,3)
        subGrid.addWidget(clearButton,0,4)
        subGrid.addWidget(saveButton,0,5)
        subGrid.addWidget(saveFigButton,0,6)
        subGrid.addWidget(clearRefButton,0,7)
        subGrid.addWidget(hideAllButton,0,8)
