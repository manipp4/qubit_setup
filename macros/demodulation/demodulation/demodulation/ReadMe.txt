...
AppWizard a créé cette DLL demodulation pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application demodulation.


demodulation.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé demodulation.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
